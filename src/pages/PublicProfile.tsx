  ...
  return (
    <div className="max-w-4xl mx-auto space-y-16 py-12">
      <div className="editorial-card overflow-hidden">
        <div className="h-28 md:h-48 bg-editorial-accent/10 border-b border-editorial-secondary/30 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="px-4 sm:px-8 md:px-12 pb-12">
          <div className="relative -mt-14 md:-mt-20 mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <div className="relative inline-block">
              <div className="p-1 bg-editorial-surface rounded-full shadow-editorial-hover">
                <Avatar
                  photoUrl={profile.photo_url}
                  className="w-24 h-24 md:w-36 md:h-36 rounded-full border-2 border-editorial-surface"
            ...
            <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-2">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-medium text-editorial-ink tracking-tight leading-none">{profile.name}</h1>
              ...
              <button className="editorial-btn editorial-btn-accent w-full sm:w-auto px-8 py-3 text-base flex items-center justify-center group">
